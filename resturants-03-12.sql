...
--
-- Host: localhost
-- Generation Time: Dec 02, 2023 at 11:49 PM
...
(5, 'ddd', 1, 'uploads/categories/3403110654.jpg');
...
(7, 1, 'Fattoush Salad', 'dddddddddd', 15.5, 'Vegetables,Pita Bread', 'uploads/products/3403112692.jpg', 1),
(9, 1, 'Kuame French', 'Avye Oliver', 96, 'Rhiannon Rocha', 'uploads/categories/3403112384.jpg', 5);
...
INSERT INTO `orders` (`order_id`, `order_date`, `order_status`, `address`, `order_total_price`, `customer_id`, `restaurant_id`, `delivery_id`, `city_id`) VALUES
(1, '2023-12-02', 'on_way', 'الرياض', 111.5000, 1, 1, 2, 1);
...
ALTER TABLE `orders`
  ...
  ADD KEY `orders_city_id` (`city_id`);
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_city_id` FOREIGN KEY (`city_id`) REFERENCES `cities` (`city_id`) ON DELETE CASCADE,
