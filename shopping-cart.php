...
<head>
    ...
    <title>Foody - Shopping Cart</title>
    <!-- ****** CSS ****** -->
    <?php
    ...
    <section class="section_header">
        <div class="container d-flex justify-content-between">
            <div class="navigation">
                <h2><a href="index.php">Home /</a> <br> Shopping Cart</h2>
            </div>
            <div class="thumb_img">
                                ...
                                <div class="col-3">
                                    <div class="quantity">
                                        <button class="cartButton"
                                                data-id="<?php echo $row['item_id'] ?>" data-type="minus"
                                                data-cart="<?php echo $row['id'] ?>">
                                            <i class="fa-sharp fa-light fa-minus"></i>
                                        </button>
                                        <input type="number" value="<?php echo $row['qty'] ?>"
                                               id="cartInput<?php echo $row['item_id'] ?>" min="1" max="99" step="1"/>
                                        <button class="cartButton"
                                                data-id="<?php echo $row['item_id'] ?>" data-type="plus"
                                                data-cart="<?php echo $row['id'] ?>">
