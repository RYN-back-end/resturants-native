...
--
-- Host: localhost
-- Generation Time: Nov 27, 2023 at 11:01 PM
...
(6, 9, 'Fattoush Salad', 'Fattoush salad is a fresh and vibrant Middle Eastern salad known for its combination of crisp vegetables and toasted pita bread. It\'s a light and refreshing dish with a lemony, tangy dressing that\'s perfect for warm weather. Fattoush is not only delicious but also a celebration of colors, textures, and flavors.', 15.5, 'Vegetables,Pita Bread\r\n', 'uploads/products/pro2.png', 1),
...
(2, '2023-11-27', 'refused', 'الرياض', 15.5000, 1, 9, NULL);
...
(9, 'Le Jardin Enchanté', '23 Main Street, New York, NY', '845120', 'first res', '', 1, 'uploads/restaurants/1.jpg');
